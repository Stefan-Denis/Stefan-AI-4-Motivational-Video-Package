...
export default class Check {
    ...
    static async clipsOrder() {
        !fs.existsSync(path.join(__dirname, '../../../storage/config/clipsOrder.json')) && (() => {
            console.clear();
            /**
    ...
    static async videoFolder() {
        !fs.existsSync(path.join(__dirname, '../../../storage/videos')) && (() => {
            console.clear();
            /**
             * @constant clipsOrderSupposedPath
             * @description The path where the clipsOrder.json file is supposed to be.
    ...
    static async videoFiles() {
        ...
        videos.forEach(video => {
             ...
             */
            !fs.existsSync(path.join(__dirname, '../../../storage/videos/' + video)) && (() => {
                console.clear();
                /**
                 * @constant clipsOrderSupposedPath
                 * @description The path where the clipsOrder.json file is supposed to be.
    ...
    static async checkVideoDimensions(video) {
        /**
    ...
    static async videoAndScriptCount() {
        const scripts = await TTS.parseScript();
